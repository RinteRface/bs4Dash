...
template like changing the sidebars and cards animation speed, ...
 ...
 When __fullscreen__ is TRUE, an icon is displayed in the navbar to switch to full screen mode. 
 __help__ automatically enable/disable all tooltips and popover that are present in the shiny app. 
 This is an easier approach than using the server methods `addPopover()`, `addTooltip()`, ... but less 
 specific.
