...
server <- function(input, output, session) {
  ...
  observeEvent(input$update_box, {
    updateBox(
      ...
      action = "update",
      options = list(
        title = tagList(h2("New title"), dashboardBadge(1, color = "primary")),
        status = "danger",
        solidHeader = TRUE,
        width = 4
      )
...
<div class="screen">
<iframe width="100%" src="https://dgranjon.shinyapps.io/bs4Dash-box-api/" allowfullscreen="" frameborder="0" scrolling="yes" height="770px"></iframe>
</div>
<div class="home"></div>
</div>
...
<div class="camera"></div>
<div class="screen">
<iframe width="100%" src="https://dgranjon.shinyapps.io/bs4Dash-box-sidebar/" allowfullscreen="" frameborder="0" scrolling="yes" height="770px"></iframe>
</div>
<div class="home"></div>
</div>
...
<div class="camera"></div>
<div class="screen">
<iframe width="100%" src="https://dgranjon.shinyapps.io/bs4Dash-box-dropdown/" allowfullscreen="" frameborder="0" scrolling="no" height="770px"></iframe>
</div>
<div class="home"></div>
</div>
...
<div class="camera"></div>
<div class="screen">
<iframe width="100%" src="https://dgranjon.shinyapps.io/bs4Dash-userBox/" allowfullscreen="" frameborder="0" scrolling="yes" height="770px"></iframe>
</div>
<div class="home"></div>
</div>
...
<div class="camera"></div>
<div class="screen">
<iframe width="100%" src="https://dgranjon.shinyapps.io/bs4Dash-socialBox/" allowfullscreen="" frameborder="0" scrolling="yes" height="770px"></iframe>
</div>
<div class="home"></div>
</div>
