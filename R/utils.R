...
#'
#' \itemize{
#'   \item `primary` Blue (sometimes dark blue)
#'   \item `secondary` Light gray
#'   \item `info` Blue
#'   \item `success` Green
#'   \item `warning` Orange
#'   \item `danger` Red
...
#' \itemize{
#'   \item `indigo` Indigo
#'   \item `lightblue` Light blue
#'   \item `navy` Dark Grey/Blue
#'   \item `purple` Purple
#'   \item `fuchsia` Fuchsia
#'   \item `pink` Pink
#'   \item `maroon` Pink
#'   \item `orange` Orange
#'   \item `lime` Light green
#'   \item `teal` Blue/Green
#'   \item `olive` Pastel green
#' }
#'
#' @usage NULL
#' @format NULL
